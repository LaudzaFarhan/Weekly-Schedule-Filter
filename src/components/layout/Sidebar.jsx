...
import { useSchedule, DEFAULT_SIDEBAR_ORDER } from '@/contexts/ScheduleContext';
import {
...
const NAV_ITEM_DEFINITIONS = {
  ...
  schedule: {
    ...
    render: ({ currentPage, onNavigate, canAccess, schedulePagesActive, scheduleOpen, setScheduleOpen }) => (
      <>
        <button
  ...
  students: {
    ...
    render: ({ currentPage, onNavigate, studentPagesActive, studentsOpen, setStudentsOpen }) => (
      <>
        <button
  ...
  'report-cards': {
    ...
    render: ({ currentPage, onNavigate, reportCardsActive, reportCardsOpen, setReportCardsOpen }) => (
      <>
        <button
  ...
  'live-progress': {
    ...
    render: ({ currentPage, onNavigate, liveProgressActive, liveProgressOpen, setLiveProgressOpen }) => (
      <>
        <button
...
export default function Sidebar({ currentPage, onNavigate, onToggleSearch, opsMode = 'old', setOpsMode, onToggleSidebar, sidebarCollapsed, sunsetBadge }) {
  ...
  const { roleToggles, users, featureToggles, rolePermissions, userPermissions, sidebarOrder, updateSidebarOrder } = useSchedule();
